          ...
          airportsInstance
            ...
            .then((data) => {
              ...
              for (var i = 0; i < airportsCount; i++) {
                address = airportsInstance.getAirportAddress(i, { from: App.account });
                name = airportsInstance.getAirportName(i, { from: App.account });
                price = airportsInstance.getAirportPrice(i, { from: App.account });
                ...
                // address = airportsInstance.getAirportsAddress(i, { from: App.account });
                ...
                //         airportsInstance.getAirportPricePerBag( { from: App.account }).then((data) => {
              ...
              console.log("Final List ", App.airports);
      ...
      App.contracts.claim
        ...
        .then(function (instance) {
          ...
          return airportsRequestInstance.requestToClaimBaggage(
            ...
            {
              from: account,
              value: web3.eth.toWei(amountToSend, "ether"),
            }
          );
        })
        .then(function (result, err) {
