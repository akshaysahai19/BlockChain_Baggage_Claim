              ...
              for (var i = 0; i < airportsCount; i++) {
                ...
                airportsInstance
                  ...
                  .then((data) => {
                    ...
                    if(App.airports[i]!=null){
                        App.airports[i].address = address;
                        console.log("App.airports FinalList = ", App.airports);

                        airportsInstance
                  .getAirportMembershipStatus({ from: address })
                  .then((data) => {
                    console.log("getAirportMembershipStatus data ", data);
                    if (data.c[0] != 1) {
                      console.log(App.airports);
                      
                      if(App.airports[i]!=null){
                        App.airports.remove(i);
