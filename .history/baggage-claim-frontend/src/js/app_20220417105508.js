App = {
          ...
          airportsInstance
            ...
            .then((data) => {
              ...
              for (var i = 0; i < airportsCount; i++) {
                ...
                var airportAddress = airportsInstance.getAirport(i, { from: App.account });
                console.log("airportsCount", await airportsInstance.getAirport(i, { from: App.account }));
  ...
  fetchAirports: async function (index) {
    var name;
              var address;
              var price;
