App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#claimBaggageRequest', function(){ var sellingAirportWhileClaim = $('#sellingAirportWhileClaim').val();var totalClaimBaggageNumber = $('#totalClaimBaggageNumber').val();var hashDetailsWhileClaim = $('#hashDetailsWhileClaim').val(); App.handleRequestBaggage(totalClaimBaggageNumber, hashDetailsWhileClaim); });//claim request
