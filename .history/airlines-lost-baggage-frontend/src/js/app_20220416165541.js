App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#pay', function(){ var sellingAirportWhileClaim = $('#sellingAirportWhileClaim').val();var hashDetailsWhilePayment = $('#hashDetailsWhilePayment').val(); App.handleSettlePayment(sellingAirportWhileClaim, totalClaimBaggageNumber, hashDetailsWhileClaim); });//claim response
