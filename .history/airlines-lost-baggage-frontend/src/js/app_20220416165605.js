App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#pay', function(){ var sellingAirportWhileSettle = $('#sellingAirportWhileSettle').val();var hashDetailsWhilePayment = $('#hashDetailsWhileSettle').val(); App.handleSettlePayment(sellingAirportWhileSettle, totalClaimBaggageNumber, hashDetailsWhileClaim); });//claim response
