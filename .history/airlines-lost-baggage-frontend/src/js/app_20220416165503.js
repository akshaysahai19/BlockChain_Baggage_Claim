App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#pay', function(){ var hashDetailsWhilePayment = $('#hashDetailsWhilePayment').val(); App.hand(sellingAirportWhileClaim, totalClaimBaggageNumber, hashDetailsWhileClaim); });//claim response
