App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#pay', function(){ var sellingAirportWhileSettle = $('#sellingAirportWhileClaim').val();var hashDetailsWhilePayment = $('#hashDetailsWhilePayment').val(); App.handleSettlePayment(sellingAirportWhileClaim, totalClaimBaggageNumber, hashDetailsWhileClaim); });//claim response
