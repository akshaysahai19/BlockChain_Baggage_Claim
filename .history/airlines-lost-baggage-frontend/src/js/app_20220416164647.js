App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#claimBaggageRequest', function(){ var totalAddBaggageNumber = $('#totalClaimBaggageNumber').val(); App.handleAddBaggage(totalAddBaggageNumber); });//claim request
