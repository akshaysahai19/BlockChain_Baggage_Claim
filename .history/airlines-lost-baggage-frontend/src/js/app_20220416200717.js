...
// For now, 'eth_accounts' will continue to always return an array
  ...
  screenFilter: function(memeberShip){
    if(memeberShip==0){
      ...
      $("#airline").css("visibility","visible");
      $("#airline").css("height","auto");
      $("#airline").css("width","auto");
      $("#airline").css("margin-top","0px");
      $("#airline").css("margin-bottom","0px");
      $("#airline").css("margin-left","0px");
      $("#airline").css("margin-right","0px");
      $("#airline").css("padding-top","0px");
      $("#airline").css("padding-bottom","0px");
      $("#airline").css("padding-left","0px");
      $("#airline").css("padding-right","0px");
      $("#airline").css("border-top-width","0px");
      $("#airline").css("border-bottom-width","0px");
      $("#airline").css("border-left-width","0px");
      $("#airline").css("border-right-width","0px");
      $("#airline").css("border-top-style","none");
      $("#airline").css("border-bottom-style","none");
      $("#airline").css("border-left-style","none");
      $("#airline").css("border-right-style","none");
      $("#airline").css("border-top-color","transparent");
      $("#airline").css("border-bottom-color","transparent");
      $("#airline").css("border-left-color","transparent");
      $("#airline").css("border-right-color","transparent");
      $("#airline").css("float","none");
      $("#airline").css("clear","none");
      $("#airline").css("display","block");
      $("#airline").css("overflow","visible");
      $("#airline").css("overflow-x","visible
    }
  }
