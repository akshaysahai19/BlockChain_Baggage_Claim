App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#addBaggage', function(){ var totalAddBaggageNumber = $('#totalAddBaggageNumber').val(); var perPriceBag = $('#perPriceBag').val();App.handleAddBaggage(airportname,perPriceBag); });//add baggage
