App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#addBaggage', function(){ var totalAddBaggageNumber = $('#airportName').val(); var perPriceBag = $('#perPriceBag').val();App.handleAddBaggage(airportname,perPriceBag); });//add baggage
