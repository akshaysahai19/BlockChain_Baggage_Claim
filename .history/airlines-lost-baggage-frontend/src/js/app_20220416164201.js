App = {
  ...
  bindEvents: function() {//totalAddBaggageNumber
    ...
    $(document).on('click', '#addBaggage', function(){ var airportname = $('#airportName').val(); var perPriceBag = $('#perPriceBag').val();App.handleAddBaggage(airportname,perPriceBag); });//add baggage
