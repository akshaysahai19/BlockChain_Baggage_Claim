App = {
  ...
  bindEvents: function() {
    $(document).on('click', '#airportRegister', function(){ var airportname = $('#airportName').val(); var perPriceBag = $('#perPriceBag').val();App.handleRegistration(ad); });//register airlines
