App = {
    ...
    $.getJSON("AirlineLostBaggage.json", function (data) {
      ...
      App.contracts.claim
        ...
        .then(function (instance) {
          ...
          var airlinesCount;
          airlinesInstance
            .getAirlinesCount({ from: App.account })
            .then((data) => {
              ...
              for (var i = 0; i < airlinesCount; i++) {
                ...
                var address;
                airlinesInstance
                  .getAirlinesName(i, { from: App.account })
                  .then((data) => {
                    console.log("name", data);
                    name = data;
                  });
                airlinesInstance
                  .getAirlinesAddress(i, { from: App.account })
                  .then((data) => {
                ...
                airlinesInstance
                  .getAirlineMembershipStatus(address, { from: App.account })
                  .then((data) => {
                    if (data == 1) {
  ...
  bindEvents: function () {
    ...
    $(document).on("click", "#claimBaggageResponse", function () {
      var totalClaimBaggageNumber = $("#totalClaimBaggageNumber").val();
    ...
    web3.eth.getAccounts(function (error, accounts) {
      ...
      App.contracts.claim
        ...
        .then(function (instance) {
          ...
          return airlinesRegistryInstance.registerAirlines(
            airlinesName,
            pricePerBaggage,
            { from: account }
          );
    ...
    web3.eth.getAccounts(function (error, accounts) {
      ...
      App.contracts.claim
        ...
        .then(function (instance) {
          ...
          return airlinesRequestInstance.requestToClaimBaggage(
            sellingAirline,
            hashDetails,
            bagCount,
            {
              from: account,
              value: web3.toWei(web3.eth.getBalance(account), "wei"),
            }
          );
        })
        .then(function (result, err) {
    ...
    web3.eth.getAccounts(function (error, accounts) {
      ...
      App.contracts.claim
        ...
        .then(function (instance) {
          ...
          return airlinesResponseInstance.responseToClaimBaggage(
            done,
            hashOfDetails,
            { from: account }
          );
    ...
    web3.eth.getAccounts(function (error, accounts) {
      ...
      App.contracts.claim
        ...
        .then(function (instance) {
          ...
          return airlinesSettleInstance.settlePayment(
            sellingAirline,
            hashOfDetails,
            { from: account }
          );
    ...
    web3.eth.getAccounts(function (error, accounts) {
      ...
      App.contracts.claim
        ...
        .then(function (instance) {
          ...
          return airlinesRegistryInstance.unregisterAirlines(sellingAirline, {
            from: account,
          });
        })
        .then(function (result, err) {
          if (result) {
            ...
            if (parseInt(result.receipt.status) == 1) {
              ...
              App.updateRemoveAirline(sellingAirline);
            } else
  ...
  updateRemoveAirline: function (sellingAirline) {
    App.airports = App.airports.filter((x) => x[1] !== sellingAirline);
    App.handleUpdateAirlinesList();
  },
  ...
  checkMemeberShipStatus: function () {
    ...
    App.contracts.claim
      ...
      .then(function (instance) {
        claimInstance = instance;
        return claimInstance.getAirlineMembershipStatus({ from: App.account });
      })
      .then(function (res) {
        console.log(res);
