App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#claimBaggageRequest', function(){ var totalClaimBaggageNumber = $('#totalClaimBaggageNumber').val();var totalClaimBaggageNumber = $('#totalClaimBaggageNumber').val();var totalClaimBaggageNumber = $('#hashDetailsWhileClaim').val(); App.handleRequestBaggage(totalClaimBaggageNumber); });//claim request
