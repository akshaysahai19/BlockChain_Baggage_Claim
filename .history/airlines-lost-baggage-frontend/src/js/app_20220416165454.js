App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#pay', function(){ var hashDetailsWhilePayment = $('#hashDetailsWhilePayment').val();var hashDetailsWhileClaim = $('#hashDetailsWhileClaim').val(); App.handleRequestBaggage(sellingAirportWhileClaim, totalClaimBaggageNumber, hashDetailsWhileClaim); });//claim response
