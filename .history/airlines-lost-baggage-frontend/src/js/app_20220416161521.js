App = {
  ...
  bindEvents: function() {
    $(document).on('click', '#airportRegister', function(){ var ad = $('#airportName').val(); var ad = $('#airportName').val();var ad = $('#airportName').val();App.handleRegistration(ad); });//register airlines
