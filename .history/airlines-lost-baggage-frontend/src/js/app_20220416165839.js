App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#airportUnregister', function(){ var airportname = $('#airportName').val(); var perPriceBag = $('#perPriceBag').val();App.handleRegistration(airportname,perPriceBag); });//register airlines
