App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#pay', function(){ var hashDetailsWhilePayment = $('#hashDetailsWhilePayment').val(); App.handleRequestBaggage(sellingAirportWhileClaim, totalClaimBaggageNumber, hashDetailsWhileClaim); });//claim response
