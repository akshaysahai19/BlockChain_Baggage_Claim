    ...
    web3.eth.getAccounts(function(error, accounts) {
      ...
      App.contracts.claim.deployed().then(function(instance) {
        ...
        web3.eth.getBalance(account).then(function(balance){
          amountInAccount = balance.toNumber();
          console.log("amountInAccount: %o", amountInAccount);
          return airlinesRequestInstance.requestBaggage(sellingAirline, bagCount, hashDetails, {from: account, value: amountInAccount});
        });
