    ...
    web3.eth.getAccounts(function (error, accounts) {
      ...
      App.contracts.claim
        ...
        .then(function (instance) {
          ...
          return airportsRegistryInstance.registerAirlines(
            airportsName,
            pricePerBaggage,
            { from: account }
          );
        ...
        .then(function (result, err) {
          if (result) {
            ...
            if (parseInt(result.receipt.status) == 1) {
              ...
              App.airports.push({ name: airportsName, address: account });
              console.log(App.airports);
              App.handleUpdateAirlinesList();
              App.checkMemeberShipStatus();
            } else
    ...
    web3.eth.getAccounts(function (error, accounts) {
      ...
      App.contracts.claim
        ...
        .then(function (instance) {
          ...
          return airportsRegistryInstance.unregisterAirlines(sellingAirline, {
            from: account,
          });
        })
        .then(function (result, err) {
