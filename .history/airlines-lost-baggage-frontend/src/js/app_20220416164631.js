App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#claimBaggageRequest', function(){ var totalAddBaggageNumber = $('#totalAddBaggageNumber').val(); App.handleAddBaggage(totalAddBaggageNumber); });//claim request
