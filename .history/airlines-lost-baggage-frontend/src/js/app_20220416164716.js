App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#claimBaggageRequest', function(){ var totalClaimBaggageNumber = $('#totalClaimBaggageNumber').val(); App.handlec(totalClaimBaggageNumber); });//claim request
