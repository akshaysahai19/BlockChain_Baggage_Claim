App = {
  ...
  bindEvents: function() {
    $(document).on('click', '.btn-vote', App.handleRegistration(App.event, ""));//register airlines
  ...
  handleRegistration: function(event, airlineAddress) {
    ...
    var airlineAddress = "0x576A9E8352F954B2Ed3C3c0524EC1fd380Ace699";// hardcoded address
    var airlinesName = "A";
    ...
    web3.eth.getAccounts(function(error, accounts) {
      ...
      App.contracts.claim.deployed().then(function(instance) {
        ...
        return airlinesRegistryInstance.registerAirlines(airlinesName, pricePerBaggage, {from: airlineAddress});
      }).then(function(result, err){
            if(result){
              console.log("result: %o", result);
