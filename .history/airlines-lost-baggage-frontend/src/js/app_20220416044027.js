App = {
  ...
  initContract: function() {
      $.getJSON("../airlines-lost-baggage-contract/build/contracts/AirportAuthority.json", function(airportAuthorityArtifact) {
    // Get the necessary contract artifact file and instantiate it with truffle-contract
    App.contracts.claim = TruffleContract(airportAuthorityArtifact);
