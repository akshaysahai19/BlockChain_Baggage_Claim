App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#claimBaggageRequest', function(){ var totalClaimBaggageNumber = $('#totalClaimBaggageNumber').val();var totalClaimBaggageNumber = $('#totalClaimBaggageNumber').val();var totalClaimBaggageNumber = $('#totalClaimBaggageNumber').val(); App.handleRequestBaggage(totalClaimBaggageNumber); });//claim request
