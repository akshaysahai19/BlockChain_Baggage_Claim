App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#airportUnregister', function(){ var unregisterAirportName = $('#unregisterAirportName').val(); App.handleRegistration(airportname,perPriceBag); });//register airlines
