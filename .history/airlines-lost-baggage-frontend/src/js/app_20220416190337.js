  ...
  initContract: function() {
    ...
    App.contracts.claim.deployed().then(function(instance) {
      ...
      for(var i = 0; i < airlinesCount; i++){
              var name ;
              var address;
              airlinesInstance.getAirlineName(i, {from: App.account}).then(data=>{} );
              airlinesInstance.getAirlineNamegetAirlineName(i, {from: App.account}).then(data=>{} );
              airlinesInstance.(i, {from: App.account});
