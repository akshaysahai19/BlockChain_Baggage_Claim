App = {
  ...
  bindEvents: function() {
    ...
    $(document).on('click', '#airportUnregister', function(){ var unregisterAirportName = $('#unregisterAirportName').val(); App.handleUnregistration(unregisterAirportName); });//register airlines
