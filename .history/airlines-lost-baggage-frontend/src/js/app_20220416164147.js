App = {
  ...
  bindEvents: function() {//totalAddBaggageNumber
    ...
    $(document).on('click', '#addBaggage', function(){ var airportname = $('#airportName').val(); var perPriceBag = $('#perPriceBag').val();App.handleRegistration(airportname,perPriceBag); });//add baggage
