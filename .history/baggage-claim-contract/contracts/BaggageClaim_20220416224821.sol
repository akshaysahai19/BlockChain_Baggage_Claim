...
contract BaggageClaim{
    ...
    function registerAirports(string memory airportsName, uint pricePerbag) public onlyAirport {
    ...
    function settlePayment(address payable toAirport, uint hashOfDetails) payable public onlyCustomer{
    ...
    function getAirportPricePerBag(address payable toAirport) public view returns(uint){
        return airportBaggage[toAirport].pricePerbag;
    }
